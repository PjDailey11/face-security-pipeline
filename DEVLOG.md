...
- Overhauled instructions to a step-by-step checklist and added first-run troubleshooting for common errors (missing weights, COCO vs face detector, webcam snapshot flow).
